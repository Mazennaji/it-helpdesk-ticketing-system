...
export default function Reports() {
  ...
  return (
    <AppLayout
      title="Reports"
      subtitle="Analytics and exportable insights across your support operation"
    >
      <div ref={rootRef}>
        <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
          ...
          <button
            onClick={() =>
              downloadCsv(`ticket-trend-${range}d.csv`, trend)
            }
            className="inline-flex items-center gap-2 px-3.5 py-2 text-xs font-medium text-slate-700 bg-white border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors"
          >
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">
                {totalTickets} tickets across the selected window
              </p>
            </div>
        ...
        <div ref={breakdownRef} className="grid lg:grid-cols-2 gap-6">
          <div className="bg-white rounded-xl border border-slate-200 p-8">
            <div className="flex items-center justify-between mb-6">
              ...
              <button
                onClick={() =>
                  downloadCsv("tickets-by-category.csv", byCategory)
                }
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-8">
            <div className="flex items-center justify-between mb-6">
              ...
              <button
                onClick={() =>
                  downloadCsv("tickets-by-priority.csv", byPriority)
                }
                className="text-xs font-medium text-blue-600 hover:text-blue-700"
              >
                Export
                ...
                <PieChart>
                  ...
                  >
                    {byPriority.map((entry) => (
                      <Cell
                        key={entry.label}
                        fill={PRIORITY_COLORS[entry.label] || "#94A3B8"}
                      />
                    ))}
                  </Pie>
                  <Tooltip
              ...
              {byPriority.map((entry) => (
                ...
                >
                  <span
                    ...
                    style={{
                      backgroundColor:
                        PRIORITY_COLORS[entry.label] || "#94A3B8",
                    }}
                  />
